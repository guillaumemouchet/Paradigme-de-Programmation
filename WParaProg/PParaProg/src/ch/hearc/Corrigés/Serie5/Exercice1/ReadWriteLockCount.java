...
package ch.hearc.Corrigés.Serie5.Exercice1;
...
public class ReadWriteLockCount
	...
	private final ReadWriteLock lock = new ReentrantReadWriteLock(true);// is fair
	private int counter = 0;

	public static void main(String[] args) throws InterruptedException
		{
		ReadWriteLockCount main = new ReadWriteLockCount();
		main.start();
		}
